...
const LoginPage: React.FC = () => {
  ...
  const bypassAuthForDev = process.env.REACT_APP_BYPASS_AUTH_FOR_DEV === 'true';
          ...
          <div className="space-y-6">
            {bypassAuthForDev && (
              <div className="bg-yellow-500/20 border border-yellow-400/50 rounded-lg p-3 text-center">
                <div className="flex items-center justify-center space-x-2 text-yellow-300">
                  ...
                  <span className="text-sm font-medium">DEV MODE: Auth Bypass Enabled</span>
                </div>
                <p className="text-yellow-200 text-xs mt-1">Authentication will be bypassed for testing</p>
              </div>
            )}
            ...
            >
              {isLoading ? (
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span>{bypassAuthForDev ? 'Continue to App (Dev Mode)' : 'Continue with Apple'}</span>
                </div>
              )}
            </button>
            ...
            <div className="text-center">
              <p className="text-sm text-blue-200">
                {bypassAuthForDev 
                  ? 'Development mode - authentication will be bypassed' 
