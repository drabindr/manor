 ...
 */
export declare function printStackDiff(oldTemplate: any, newTemplate: cxapi.CloudFormationStackArtifact, strict: boolean, context: number, quiet: boolean, changeSet?: CloudFormation.DescribeChangeSetOutput, stream?: cfnDiff.FormatStream, isImport?: boolean): number;
